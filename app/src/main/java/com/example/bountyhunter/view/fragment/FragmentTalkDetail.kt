...
import com.example.bountyhunter.model.MainApplication
import com.example.bountyhunter.utils.TimeUtil
import com.example.bountyhunter.view.adapter.LikeRecyclerViewAdapter
import com.example.bountyhunter.view.adapter.TalkCommentRecyclerViewAdapter
import com.example.bountyhunter.view.viewmodel.CommunityViewModel
import com.example.bountyhunter.widgets.*
...
//            swipeRefreshLayout.isRefreshing = true
        ...
        imageViewTalk?.setOnClickListener {
            ...
            navController.navigate(R.id.action_global_fragmentTalkDetail, bundle)
        }
