...
import com.example.bountyhunter.bean.beannew.CommentItem
...
class TalkCommentRecyclerViewAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (holder.rvCommentInner?.adapter == null) {
            holder.rvCommentInner?.adapter =
                TalkReplyRecyclerViewAdapter(mContext, onInnerItemClick, onInnerItemLongClick)
        }
